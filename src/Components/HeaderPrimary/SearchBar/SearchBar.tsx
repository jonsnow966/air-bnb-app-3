...
function SearchBar() {
  ...
  return (
    <div className="hidden md:flex bg-slate-50 w-fit rounded-full shadow-lg cursor-pointer items-center">
      ...
      >
        ...
        <div className="bg-red-500  w-12 h-12 rounded-full flex items-center justify-center z-10 hover:bg-red-600">     
          <img rel="icon" src="assets/search-icon.avif" className="w-5"></img>
        </div>
      </div>
    </div>
  )
