export default function Navbar(){
    return(
        <div className="w-full h-full flex flex-col pt-5 items-center gap-3">
            <button className="flex items-center justify-start pl-8 w-full h-fit border-none outline-none
          ...
          hover:bg-[#ddd8d8c5] py-2 cursor-pointer transition-all duration-200 ease-in-out">
            ...
            <div className="flex items-start justify-start pl-8 pr-[25px] w-full h-fit border-none outline-none
            hover:bg-[#ddd8d8c5] py-2 cursor-pointer transition-all duration-200 ease-in-out">
                Become a host
            </div>
